...
let
  ...
  password = "password";
  interface = "end0";
  hostname = "68dc623531b08fbeabf22644";
in {
  nixpkgs.overlays = [
    (final: super: {
  ...
  systemd.services.polyflow_startup = {
    ...
    serviceConfig = {
      ...
      DIRECTORY="/home/${user}/polyflow_robot_68dc623531b08fbeabf22644"
      if [[ -d "$DIRECTORY" ]];
        then
          cd "$DIRECTORY"
          ...
          ${pkgs.git}/bin/git clone https://github.com/drewswinney/polyflow_robot_68dc623531b08fbeabf22644.git
          chown -R ${user}:users /home/${user}/polyflow_robot_68dc623531b08fbeabf22644
          
          cd /home/${user}/polyflow_robot_68dc623531b08fbeabf22644/workspace/src/webrtc
          ${pkgs.python3Packages.pip}/bin/pip install -r requirements.txt

          cd /home/${user}/polyflow_robot_68dc623531b08fbeabf22644/workspace
          ${pkgs.colcon}/bin/colcon build --packages-select webrtc
          source install/setup.bash

          ${pkgs.rosPackages.humble}/bin/ros2 launch webrtc webrtc.launch.py
        fi
      ''}";
